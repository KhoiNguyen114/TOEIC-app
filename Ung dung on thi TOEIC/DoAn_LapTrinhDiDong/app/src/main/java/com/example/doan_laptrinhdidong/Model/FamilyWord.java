...
public class FamilyWord implements Serializable {
    String cauDe;
    String dapAnA;
    String dapAnB;
    String dapAnC;
    ...
    public FamilyWord(String cauDe, String dapAnA, String dapAnB, String dapAnC, String dapAnD, String dapAnDung) {
        this.cauDe = cauDe;
        this.dapAnA = dapAnA;
        this.dapAnB = dapAnB;
        this.dapAnC = dapAnC;
