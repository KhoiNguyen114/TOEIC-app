...
public class DetailBaiThiThuPart3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_bai_thi_thu_part3);

        textView1 = findViewById(R.id.textViewCauDePart3);
        radioButton1 = findViewById(R.id.rdoDapAnABaiThiThuPart3);
        radioButton2 = findViewById(R.id.rdoDapAnBBaiThiThuPart3);
        radioButton3 = findViewById(R.id.rdoDapAnCBaiThiThuPart3);
        radioButton4 = findViewById(R.id.rdoDapAnDBaiThiThuPart3);
        radioGroup = findViewById(R.id.RadioGroupBaiThiThuPart3);
        prev = findViewById(R.id.btnPrevBaiThiThuPart3);
        next = findViewById(R.id.btnNextBaiThiThuPart3);
        seekBar = findViewById(R.id.seekBarBaiThiThuPart3);
        imageButton = findViewById(R.id.imageButtonBaiThiThuPart3);
        textView3 = findViewById(R.id.textViewTimeProgressBaiThiThuPart3);
        textView4 = findViewById(R.id.textViewMaxTimeBaiThiThuPart3);
        textView5 = findViewById(R.id.textViewTimeSongSongPart3);

        arrayList = ((AppTest) getApplication()).getPart3ArrayList();
        ...
        mediaPlayer = Nghe.playSong(DetailBaiThiThuPart3Activity.this, nghe.getIDAudio());
        ...
        radioButton1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked) {
                    ...
                    ((AppTest) getApplication()).getPart3ArrayList().get(eventNum).setDapAnChon(dapAnA);
                }
            }
        });
        ...
        getSupportActionBar().setTitle("Part 3 - Question " + cau);
    ...
    {
        ArrayList<Nghe> ds = ((AppTest) getApplication()).getPart3ArrayList();
    ...
    public boolean onSupportNavigateUp() {
        Intent intent = new Intent(DetailBaiThiThuPart3Activity.this, DanhMucBaiThiThuActivity.class);
        mediaPlayer.stop();
        finish();
    ...
    public void loadArraylist(int num)
    {
        ...
        {
            Log.d("dapAN3",nghe.getDapAnChon());
