...
public class ChangeSentences implements Serializable {
    String loaiCau;
    String cauDe;
    String dapAnA;
    String dapAnB;
    ...
    public ChangeSentences(String loaiCau, String cauDe, String dapAnA, String dapAnB, String dapAnC, String dapAnD, String dapAnDung) {
        this.loaiCau = loaiCau;
        this.cauDe = cauDe;
        this.dapAnA = dapAnA;
        this.dapAnB = dapAnB;
