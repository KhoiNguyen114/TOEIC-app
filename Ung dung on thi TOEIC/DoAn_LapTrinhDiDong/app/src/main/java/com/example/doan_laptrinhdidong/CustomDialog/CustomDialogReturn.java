...
public class CustomDialogReturn extends Dialog implements View.OnClickListener {
    public Activity c;
    ...
    public CustomDialogReturn(Activity a, String diem, String xepLoai, int hinh, String tieuDe) {
        super(a);
        this.c = a;
        this.diem = diem;
