...
public class DetailBaiThiThuPart5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_bai_thi_thu_part5);

        textView1 = findViewById(R.id.textViewCauDePart5);
        radioButton1 = findViewById(R.id.rdoDapAnABaiThiThuPart5);
        radioButton2 = findViewById(R.id.rdoDapAnBBaiThiThuPart5);
        radioButton3 = findViewById(R.id.rdoDapAnCBaiThiThuPart5);
        radioButton4 = findViewById(R.id.rdoDapAnDBaiThiThuPart5);
        radioGroup = findViewById(R.id.RadioGroupBaiThiThuPart5);
        prev = findViewById(R.id.btnPrevBaiThiThuPart5);
        next = findViewById(R.id.btnNextBaiThiThuPart5);
        textView5 = findViewById(R.id.textViewTimeSongSongPart5);

        arrayList = ((AppTest) getApplication()).getPart5ArrayList();
        ...
        radioButton1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked) {
                    ...
                    ((AppTest) getApplication()).getPart5ArrayList().get(eventNum).setDapAnChon(dapAnA);
                }
            }
        });
        ...
        getSupportActionBar().setTitle("Part 5 - Question " + cau);
    ...
    {
        ArrayList<DocHieu> ds = ((AppTest) getApplication()).getPart5ArrayList();
    ...
    public boolean onSupportNavigateUp() {
        Intent intent = new Intent(DetailBaiThiThuPart5Activity.this, DanhMucBaiThiThuActivity.class);
        finish();
